...
from tailmemo.llms.base import LLMBase
...
class LangchainLLM(LLMBase):
    ...
    async def agenerate_response(
        ...
        """
        Async version: Generate a response using langchain's ainvoke.
        
        This provides true async I/O for better concurrency compared to
        running sync version in executor.
        ...
        # Use ainvoke for async I/O
        response: AIMessage = await langchain_model.ainvoke(langchain_messages)
        return self._parse_response(response, tools)
