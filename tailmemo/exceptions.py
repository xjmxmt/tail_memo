...
class MemoryCorruptionError(MemoryError):
    ...
    This exception is raised when stored memory file is found to be
    corrupted, malformed, or otherwise unreadable.

    Example:
        raise MemoryCorruptionError(
            message="Memory file is corrupted",
            error_code="CORRUPT_001",
            details={"memory_id": "mem_123"},
            suggestion="Please contact support for file recovery assistance"
        )
    """
    pass
...
class DatabaseError(MemoryError):
    ...
    such as SQLite operations, connection issues, or file corruption.
...
def create_exception_from_response(
    ...
    suggestions = {
        ...
        422: "Invalid request file. Please check your input",
